...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("src/light_casters_spot_soft/light_casters.vert", "src/light_casters_spot_soft/light_casters.frag");
    Shader lightCubeShader("src/light_casters_spot_soft/light_cube.vert", "src/light_casters_spot_soft/light_cube.frag");

...
int main()
{
    ...
    // -------------------------
    Shader lightingShader("src/light_casters_directional/light_casters.vert", "src/light_casters_directional/light_casters.frag");
    Shader lightCubeShader("src/light_casters_directional/light_cube.vert", "src/light_casters_directional/light_cube.frag");

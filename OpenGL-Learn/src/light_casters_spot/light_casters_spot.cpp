...
int main()
{
    ...
    // ------------------------------------
    Shader lightingShader("src/light_casters_spot/light_casters.vert", "src/light_casters_spot/light_casters.frag");
    Shader lightCubeShader("src/light_casters_spot/light_cube.vert", "src/light_casters_spot/light_cube.frag");

...
int main()
{
    ...
    // -------------------------
    Shader shader("src/cubemaps_environment_mapping/cubemaps.vert", "src/cubemaps_environment_mapping/cubemaps.frag");
    Shader skyboxShader("src/cubemaps_environment_mapping/skybox.vert", "src/cubemaps_environment_mapping/skybox.frag");

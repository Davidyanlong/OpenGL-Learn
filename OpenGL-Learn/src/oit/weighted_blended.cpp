...
int main(int argc, char* argv[])
{
	...
	// -------------------------
	Shader solidShader("src/oit/solid.vert", "src/oit/solid.frag");
	Shader transparentShader("src/oit/transparent.vert", "src/oit/transparent.frag");
	Shader compositeShader("src/oit/composite.vert", "src/oit/composite.frag");
	Shader screenShader("src/oit/screen.vert", "src/oit/screen.frag");

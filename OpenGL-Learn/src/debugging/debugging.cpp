...
int main()
{
    ...
    Shader shader("src/debugging/debugging.vert", "src/debugging/debugging.frag");
   ...
   -0.5f,  0.5f,  0.5f,  0.0f,  0.0f  // bottom-left        
    ...
    unsigned char* data = stbi_load(std::string("res/textures/wood.png").c_str(), &width, &height, &nrComponents, 0);
    if (data)
    {
